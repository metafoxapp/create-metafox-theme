...
async function main() {
    ...
    persist.save(input);
    console.log(chalk_1.default.green(`Generated ${packageName} located at .${realpathToApp.substring(workingDir.length)}`));
    console.log(chalk_1.default.bold.cyanBright(`Restart frontend terminal to apply ${packageName}`));
